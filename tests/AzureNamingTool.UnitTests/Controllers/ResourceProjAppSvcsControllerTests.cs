...
public class ResourceProjAppSvcsControllerTests
{
    private readonly Mock<IResourceProjAppSvcService> _mockService;
    private readonly Mock<IAdminLogService> _mockAdminLogService;
    private readonly ResourceProjAppSvcsController _controller;

    public ResourceProjAppSvcsControllerTests()
    {
        _mockService = new Mock<IResourceProjAppSvcService>();
        _mockAdminLogService = new Mock<IAdminLogService>();
        _controller = new ResourceProjAppSvcsController(_mockService.Object, _mockAdminLogService.Object);
    }
    ...
    {
        // Arrange
        var items = new List<ResourceProjAppSvc> { new ResourceProjAppSvc { Id = 1, Name = "Project1" } };
    ...
    {
        // Arrange
        var item = new ResourceProjAppSvc { Id = 1, Name = "Project1" };
