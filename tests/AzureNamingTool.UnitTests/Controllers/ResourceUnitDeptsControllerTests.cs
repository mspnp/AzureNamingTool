...
public class ResourceUnitDeptsControllerTests
{
    private readonly Mock<IResourceUnitDeptService> _mockService;
    private readonly Mock<IAdminLogService> _mockAdminLogService;
    private readonly ResourceUnitDeptsController _controller;

    public ResourceUnitDeptsControllerTests()
    {
        _mockService = new Mock<IResourceUnitDeptService>();
        _mockAdminLogService = new Mock<IAdminLogService>();
        _controller = new ResourceUnitDeptsController(_mockService.Object, _mockAdminLogService.Object);
    }
    ...
    {
        // Arrange
        var items = new List<ResourceUnitDept> { new ResourceUnitDept { Id = 1, Name = "IT" } };
    ...
    {
        // Arrange
        var item = new ResourceUnitDept { Id = 1, Name = "IT" };
