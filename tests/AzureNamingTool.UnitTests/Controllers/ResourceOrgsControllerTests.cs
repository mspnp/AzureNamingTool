...
public class ResourceOrgsControllerTests
{
    private readonly Mock<IResourceOrgService> _mockService;
    private readonly Mock<IAdminLogService> _mockAdminLogService;
    private readonly ResourceOrgsController _controller;

    public ResourceOrgsControllerTests()
    {
        _mockService = new Mock<IResourceOrgService>();
        _mockAdminLogService = new Mock<IAdminLogService>();
        _controller = new ResourceOrgsController(_mockService.Object, _mockAdminLogService.Object);
    }
    ...
    {
        // Arrange
        var item = new ResourceOrg { Id = 1, Name = "Contoso" };
