...
public class ResourceEnvironmentsControllerTests
{
    private readonly Mock<IResourceEnvironmentService> _mockService;
    private readonly Mock<IAdminLogService> _mockAdminLogService;
    private readonly ResourceEnvironmentsController _controller;

    public ResourceEnvironmentsControllerTests()
    {
        _mockService = new Mock<IResourceEnvironmentService>();
        _mockAdminLogService = new Mock<IAdminLogService>();
        _controller = new ResourceEnvironmentsController(_mockService.Object, _mockAdminLogService.Object);
    }
    ...
    {
        // Arrange
        var items = new List<ResourceEnvironment> { new ResourceEnvironment { Id = 1, Name = "Dev" } };
    ...
    {
        // Arrange
        var item = new ResourceEnvironment { Id = 1, Name = "Dev" };
