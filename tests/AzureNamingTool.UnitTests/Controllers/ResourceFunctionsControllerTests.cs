...
public class ResourceFunctionsControllerTests
{
    private readonly Mock<IResourceFunctionService> _mockService;
    private readonly Mock<IAdminLogService> _mockAdminLogService;
    private readonly ResourceFunctionsController _controller;

    public ResourceFunctionsControllerTests()
    {
        _mockService = new Mock<IResourceFunctionService>();
        _mockAdminLogService = new Mock<IAdminLogService>();
        _controller = new ResourceFunctionsController(_mockService.Object, _mockAdminLogService.Object);
    }
    ...
    {
        // Arrange
        var item = new ResourceFunction { Id = 1, Name = "Web" };
