...
{
    private readonly Mock<IResourceTypeService> _mockService;
    private readonly Mock<IAdminLogService> _mockAdminLogService;
    private readonly ResourceTypesController _controller;

    public ResourceTypesControllerTests()
    {
        _mockService = new Mock<IResourceTypeService>();
        _mockAdminLogService = new Mock<IAdminLogService>();
        _controller = new ResourceTypesController(_mockService.Object, _mockAdminLogService.Object);
    }
    ...
    {
        // Arrange
        var items = new List<ResourceType> { new ResourceType { Id = 1, Resource = "Virtual Machine" } };
    ...
    {
        // Arrange
        var item = new ResourceType { Id = 1, Resource = "Virtual Machine" };
