...
{
    private readonly Mock<IResourceComponentService> _mockService;
    private readonly Mock<IAdminLogService> _mockAdminLogService;
    private readonly ResourceComponentsController _controller;

    public ResourceComponentsControllerTests()
    {
        _mockService = new Mock<IResourceComponentService>();
        _mockAdminLogService = new Mock<IAdminLogService>();
        _controller = new ResourceComponentsController(_mockService.Object, _mockAdminLogService.Object);
    }
    ...
    {
        // Arrange
        var items = new List<ResourceComponent> { new ResourceComponent { Id = 1, Name = "Component1" } };
    ...
    {
        // Arrange
        var item = new ResourceComponent { Id = 1, Name = "Component1" };
