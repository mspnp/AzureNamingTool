...
1. **Update App Service Runtime to .NET 10.0:**
   ...
   **Option B: Azure CLI**
   ...
   > ⚠️ **IMPORTANT:** Azure CLI commands may not reliably set the runtime stack. After running these commands, **you MUST verify and manually set the Stack Settings in the Azure Portal** to ensure .NET 10 is properly configured.
